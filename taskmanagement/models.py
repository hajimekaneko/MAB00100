...
class TaskGroup(models.Model):
    ...
    TaskGroup_sortId = models.IntegerField(verbose_name='ソートキー', null=False, blank=False)
    # TaskGroup_TaskType = models.ForeignKey(TaskType, on_delete=models.CASCADE, null=False)
    TaskGroup_name = models.CharField(verbose_name='名前', max_length=20, null=False, blank=False)
    TaskGroup_status = models.ForeignKey(TaskStatus, on_delete=models.CASCADE, null=False)
...
class Task(models.Model):
    ...
    Task_sortId = models.IntegerField(verbose_name='ソートキー', null=False, blank=False)
    Task_name = models.CharField(verbose_name='名前', max_length=20, null=True, blank=True)
    Task_status = models.ForeignKey(TaskStatus, on_delete=models.CASCADE, null=False)
...
class List(models.Model):
    ...
    List_sortId = models.IntegerField(verbose_name='ソートキー', null=False, blank=False)
    List_name = models.CharField(verbose_name='名前', max_length=20, null=True, blank=True)
    List_status = models.ForeignKey(TaskStatus, on_delete=models.CASCADE, null=False)
